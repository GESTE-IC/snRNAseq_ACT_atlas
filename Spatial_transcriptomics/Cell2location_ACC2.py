...
adata_vis = sq.read.visium(path=st_data_folder, counts_file="ACC2a_filtered_feature_bc_matrix.h5", source_image_path=st_data_folder + "/spatial/tissue_hires_image.png")
